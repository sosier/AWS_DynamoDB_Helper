...
```
    ...
    >>
    >>
    >> ~/.../.../.../aws_dynamodb_helper.py in __getitem__(self, item)
    >>      99
...
```
    ...
    >>
    >>
    >> ~/.../.../.../aws_dynamodb_helper.py in __setitem__(self, item, value)
    ...
    >>
    >>
    >> ~/.../.../.../aws_dynamodb_helper.py in __value_to_type(self, value)
    >>      91                             + f"{type(value)}.\n\n"
    ...
    >>
    >>
    >> Exception: Your object is of an unsupported type: <class 'list'>.
    >>
